...
console.log(edades[7][1]); //["Juan","Luis"]
...
cursos.unshift("React Nativa");
console.log("unshift", cursos);
cursos[1].unshift(Nextjs);
console.log("adsadas", cursos);
...
// For es un bucle, una estructura que se repite n veces
// Sintaxys de for

// cursos.legth => retorna la cantidad de elementos
console.log("==========")
